...
namespace training102.Data
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="Training101")]
    ...
    partial void InsertMyHisto(MyHisto instance);
    partial void UpdateMyHisto(MyHisto instance);
    partial void DeleteMyHisto(MyHisto instance);
    #endregion
		...
		public System.Data.Linq.Table<MyInfo> MyInfos
		{
			get
			{
				return this.GetTable<MyInfo>();
			}
		}
		...
		public System.Data.Linq.Table<MyHisto> MyHistos
		{
			get
			{
				return this.GetTable<MyHisto>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MyInfo")]
	public partial class MyInfo
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Mname", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		public string Mname
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.MyHisto")]
	public partial class MyHisto : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnFromAddChanging(string value);
    partial void OnFromAddChanged();
    partial void OnToAddChanging(string value);
    partial void OnToAddChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_InfoID", DbType="Int NOT NULL")]
		public int InfoID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FromAdd", DbType="NVarChar(50)")]
		public string FromAdd
		{
			get
			{
				return this._FromAdd;
			}
			set
			{
				if ((this._FromAdd != value))
				{
					this.OnFromAddChanging(value);
					this.SendPropertyChanging();
					this._FromAdd = value;
					this.SendPropertyChanged("FromAdd");
					this.OnFromAddChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ToAdd", DbType="NVarChar(50)")]
		public string ToAdd
		{
			get
			{
			...
			set
			{
				...
				{
					this.OnToAddChanging(value);
					this.SendPropertyChanging();
					this._ToAdd = value;
					this.SendPropertyChanged("ToAdd");
					this.OnToAddChanged();
				}
			}
		}
